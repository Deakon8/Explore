...
namespace PC2D
{
    ...
    public class PlatformerAnimation2D : MonoBehaviour
    {
        ...
        void Start()
        {
			...
			if (charapter == 1) {
				visualChild = GameObject.Find ("char_anim_1");
				GameObject.Find("char_anim_2").SetActive (false);
			}
			if (charapter == 2) {
				visualChild = GameObject.Find ("char_anim_2");
				GameObject.Find("char_anim_1").SetActive (false);
			}
