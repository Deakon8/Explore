...
public class Localization : MonoBehaviour {
	...
	[SerializeField] private Canvas[] canvas = null; // здесь указываем Canvas, для дочерних текстовых элементов которых, предусмотрена локаль
	[SerializeField] private Dropdown dropdown = null; // меню для переключения языка
